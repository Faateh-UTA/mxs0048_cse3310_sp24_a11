...
public class Game {
    ...
    Game() {
        ...
        Msg[1] = "";
        bottomMsg[0] =  "Games Played: " + Integer.toString(gamesPlayed) + 
                        "\nConcurrent games: " + Integer.toString(concurrent) + 
                        "\nX Wins: " + Integer.toString(XWins) +
                        "\nO Wins: " + Integer.toString(OWins) +
                        "\nDraws: " + Integer.toString(draws);
        bottomMsg[1] = "Games Played: " + Integer.toString(gamesPlayed) + 
                        "\nConcurrent games: " + Integer.toString(concurrent) + 
                        "\nX Wins: " + Integer.toString(XWins) +
                        "\nO Wins: " + Integer.toString(OWins) +
                        "\nDraws: " + Integer.toString(draws);
